...
macro(
  ...
  foreach( _PACKAGE_INCLUDE_DESTINATION ${PACKAGE_INCLUDE_DESTINATION})
    list(APPEND DEPENDENCIES_INCLUDE_DIRS "${CMAKE_INSTALL_PREFIX}/${_PACKAGE_INCLUDE_DESTINATION}")
  endforeach()
