...
TEST(EigeTest, EigenTest)
{
  ...
  Eigen::VectorXd            ve_lhs_x(3);     ve_lhs_x << 1.1, 2.2, 3.3;
  Eigen::MatrixXd            me_lhs_x(3,1);   me_lhs_x << 1.1, 2.2, 3.3;
  Eigen::MatrixXd            me_lhs_x_2(3,1); me_lhs_x_2 << 1.1, 2.2, 3.3;
  Eigen::Matrix<double,1,1>  ve_lhs_1;        ve_lhs_1 << 1.1;
  Eigen::Matrix<double,2,1>  ve_lhs_2;        ve_lhs_2 << 1.1, 2.2;
  Eigen::Matrix<double,3,1>  ve_lhs_3;        ve_lhs_3 << 1.1, 2.2, 3.3;
  Eigen::VectorXd            ve_rhs_x(3);     ve_rhs_x << 1.1, 2.2, 3.3;
  Eigen::MatrixXd            me_rhs_x(3,1);   me_rhs_x << 1.1, 2.2, 3.3;
  Eigen::MatrixXd            me_rhs_x_2(3,1); me_rhs_x_2 << 1.1, 2.2, 3.3;
  Eigen::Matrix<double, 1,1> ve_rhs_1;        ve_rhs_1 << 1.1;
  Eigen::Matrix<double, 2,1> ve_rhs_2;        ve_rhs_2 << 1.1, 2.2;
  Eigen::Matrix<double, 3,1> ve_rhs_3;        ve_rhs_3 << 1.1, 2.2, 3.3;
...
TEST(YamlUtilities, ClientUsageBasicTypes)
{
  ...
  EXPECT_TRUE (vv_double.size() == 3 && vv_double.front().size() == 3 && vv_double[0][0] == 11 && vv_double[0][1] == 12 && vv_double[0][2] == 13);
  EXPECT_TRUE (vv_double.size() == 3 && vv_double.front().size() == 3 && vv_double[1][0] == 21 && vv_double[1][1] == 22 && vv_double[1][2] == 23);
  EXPECT_TRUE (vv_double.size() == 3 && vv_double.front().size() == 3 && vv_double[2][0] == 31 && vv_double[2][1] == 32 && vv_double[2][2] == 33);

  EXPECT_TRUE (call("n1/n4/vv2", vv_double, false));

  EXPECT_TRUE (call("n1/n4/vv2", me_double));
  EXPECT_TRUE (me_double.rows() == 3 && me_double.cols() == 3 && me_double(0,0) == 11 && me_double(0,1) == 12 && me_double(0,2) == 13 );
  EXPECT_TRUE (me_double.rows() == 3 && me_double.cols() == 3 && me_double(1,0) == 21 && me_double(1,1) == 22 && me_double(1,2) == 23 );
  EXPECT_TRUE (me_double.rows() == 3 && me_double.cols() == 3 && me_double(2,0) == 31 && me_double(2,1) == 32 && me_double(2,2) == 33 );

  EXPECT_TRUE (call("n1/n4/vv3", vv_double, true));
  EXPECT_TRUE (vv_double.size() == 2 && vv_double.front().size() == 3 && vv_double[0][0] == 11.1 && vv_double[0][1] == 12.2 && vv_double[0][2] == 13.3);
  EXPECT_TRUE (vv_double.size() == 2 && vv_double.front().size() == 3 && vv_double[1][0] == 21.1 && vv_double[1][1] == 22.2 && vv_double[1][2] == 23.3);

  EXPECT_TRUE (call("n1/n4/vv3", vv_double, false));

  EXPECT_TRUE (call("n1/n4/vv3", me_double));
  EXPECT_TRUE (me_double.rows() == 2 && me_double.cols() == 3 && me_double(0,0) == 11.1 && me_double(0,1) == 12.2 && me_double(0,2) == 13.3 );
  EXPECT_TRUE (me_double.rows() == 2 && me_double.cols() == 3 && me_double(1,0) == 21.1 && me_double(1,1) == 22.2 && me_double(1,2) == 23.3 );
}
...
int main(int argc, char** argv)
{
  ...
  {
    std::cerr << "Could not open camera param file " << yaml_file << std::endl;;
  } 
  else 
  {
